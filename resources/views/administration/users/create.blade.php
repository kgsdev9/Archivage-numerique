        ...
        <div>
            <form class="row gx-3 needs-validation" novalidate="" action="{{route('users.store')}}" method="POST">
                ...
                <div class="mb-3 col-12 col-md-6">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="Nom d'utilisateur" required="">
                </div>
                <div class="mb-3 col-12 col-md-6">
                ...
                <div class="mb-3 col-12 col-md-6">
                    ...
                    <select class="form-select" id="role_id" name="role_id" required="">
                        ...
                        <option value="{{$vlisteroles->id}}">{{$vlisteroles->libelle}}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3 col-12 col-md-6">
                    ...
                    <select class="form-select" id="departement_id" name="departement_id" required="">
                        ...
                        <option value="{{$vlistedepartements->id}}">{{$vlistedepartements->libelle}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3 col-12 col-md-6">
